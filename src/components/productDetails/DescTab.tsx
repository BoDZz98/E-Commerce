export function DescTab(){
    return <div className="flex flex-col">
    <h3>Product Description</h3>
    <p className="bg-gray-100 rounded-lg p-4 mt-3">
      ...
      invidunt. Dolore magna est eirmod sanctus dolor, amet diam et eirmod
      ...
      clita. Sea amet et sed ipsum lorem elitr et, amet et labore voluptua
      sit rebum. Ea erat sed et diam takimata sed justo. Magna takimata
