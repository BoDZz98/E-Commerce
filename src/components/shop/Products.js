  ...
  return (
    <div className="gap-y-10 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 ">
      {productsDetails.map((product) => (
        <div
          id={product.id}
          class="w-full  max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 transition ease-in-out delay-150 hover:scale-110 duration-300"
        >
          <Link to={`${product.id}`}>
            <img
